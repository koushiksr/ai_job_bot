...
export const INITIAL_SAMPLE_REVIEWS: Array<Omit<ReviewItem, 'id'>> = [
  ...
  },
  {
    ...
    review_text: 'Manually searching and applying to jobs used to consume hours every night after work. JobFlux tailored my ATS keywords for each machine learning opening and applied autonomously. Scheduled two technical rounds within 2 weeks.',
    verified: true,
    featured: true,
    status: 'approved',
  ...
  },
  {
    ...
    rating: 5,
    satisfaction_level: 'Top 5% Recruiter Search Visibility',
