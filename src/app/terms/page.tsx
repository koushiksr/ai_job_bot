      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 sm:py-16 space-y-12">
        <div className="space-y-4 text-center sm:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 light:bg-zinc-100 border border-zinc-800 light:border-zinc-200 text-[11px] font-mono text-zinc-400 light:text-zinc-600 uppercase tracking-wider">
            <Scale className="w-3.5 h-3.5 text-zinc-400 light:text-zinc-600" />
        ...
        <section className="space-y-3 border-t border-zinc-900 light:border-zinc-200 pt-8">
          <h3 className="text-base font-semibold text-white light:text-zinc-900 flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-zinc-400 light:text-zinc-600" />
        ...
        <section className="space-y-3 border-t border-zinc-900 light:border-zinc-200 pt-8">
          <h3 className="text-base font-semibold text-white light:text-zinc-900 flex items-center gap-2">
            <Shield className="w-4 h-4 text-zinc-400 light:text-zinc-600" />
        ...
        <section className="space-y-3 border-t border-zinc-900 light:border-zinc-200 pt-8">
          <h3 className="text-base font-semibold text-white light:text-zinc-900 flex items-center gap-2">
            <FileText className="w-4 h-4 text-zinc-400 light:text-zinc-600" />
        ...
        <section className="space-y-3 border-t border-zinc-900 light:border-zinc-200 pt-8">
          <h3 className="text-base font-semibold text-white light:text-zinc-900 flex items-center gap-2">
            <Scale className="w-4 h-4 text-zinc-400 light:text-zinc-600" />
