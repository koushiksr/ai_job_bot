...
const TOOLS = [
  {
    ...
    badgeColor: 'bg-zinc-800 light:bg-zinc-200 text-zinc-200 light:text-zinc-800 border-zinc-700 light:border-zinc-300',
    description:
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 relative z-10 w-full space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-zinc-950 light:bg-white border border-zinc-800 light:border-zinc-200 text-zinc-300 light:text-zinc-700">
            <Zap className="w-3.5 h-3.5 text-cyan-400 light:text-cyan-600" /> 100% Free · No Sign-Up Barrier
          </div>
          <h1 className="text-3xl sm:text-5xl font-semibold text-white light:text-zinc-900 tracking-tight leading-tight">
            Free AI Career &amp; Profile <br className="hidden sm:inline" />
            <span className="text-zinc-400 light:text-zinc-600">Optimization Suite</span>
          </h1>
          <p className="text-zinc-400 light:text-zinc-600 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-12 h-12 rounded-xl bg-zinc-900 light:bg-zinc-100 border border-zinc-800 light:border-zinc-200 flex items-center justify-center text-zinc-300 light:text-zinc-700 group-hover:scale-105 transition-transform">
                      <Icon className="w-6 h-6 text-zinc-200 light:text-zinc-800" />
                    </div>
                  ...
                  <h2 className="text-base sm:text-lg font-semibold text-white light:text-zinc-900 group-hover:text-cyan-400 transition-colors mb-2.5">
                    {tool.title}
                  </h2>
                  <p className="text-zinc-400 light:text-zinc-600 text-xs leading-relaxed mb-6">
                    {tool.description}
                  </p>

                  <ul className="space-y-2.5 mb-6">
                    {tool.features.map((feat, i) => (
                      <li key={i} className="flex items-center gap-2 text-xs text-zinc-300 light:text-zinc-700">
                        <CheckCircle2 className="w-3.5 h-3.5 text-zinc-400 light:text-zinc-600 shrink-0" />
                        <span>{feat}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <div className="pt-4 border-t border-zinc-800/80 light:border-zinc-200 flex items-center justify-between text-xs font-semibold text-zinc-300 light:text-zinc-700 group-hover:text-white transition-colors">
                  <span>Open Tool Free</span>
                  <ArrowRight className="w-4 h-4 text-zinc-500 light:text-zinc-600 group-hover:text-white group-hover:translate-x-1 transition-all" />
                </div>
              </Link>
            )
          })}
        ...
        <div className="rounded-3xl border border-zinc-800 light:border-zinc-200 bg-[#09090b] light:bg-white p-8 md:p-12 relative overflow-hidden space-y-6">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-zinc-400 light:text-zinc-600 text-xs sm:text-sm leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link
                href="/?mode=trial"
                className="inline-flex items-center gap-2 bg-white light:bg-white light:ring-1 light:ring-zinc-300 hover:bg-zinc-200 light:hover:bg-zinc-100 text-black light:text-zinc-900 font-semibold text-xs sm:text-sm px-6 py-3 rounded-lg shadow-lg shadow-white/5 transition-all"
              >
              ...
              <Link
                href="/resume-builder"
                className="inline-flex items-center gap-2 bg-zinc-900 light:bg-zinc-100 hover:bg-zinc-800 light:hover:bg-zinc-200 border border-zinc-800 light:border-zinc-200 text-zinc-300 light:text-zinc-700 font-semibold text-xs sm:text-sm px-6 py-3 rounded-lg transition-all"
              >
