          ...
          <div className="w-full border-b border-zinc-900 bg-zinc-950/90 z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs">
              <div className="flex items-center gap-2 text-zinc-400 text-center sm:text-left">
                ...
                <span>Stop applying manually. AI applies to jobs for you while you sleep • <span className="text-zinc-200 font-medium">Free to start</span></span>
              </div>
          ...
          >
            <div>
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-white leading-[1.08]">
                AI that applies to <br className="hidden sm:inline" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-zinc-400">jobs for you.</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
              {existingUser ? (
                ...
                <button
                  type="button"
                  onClick={() => scrollToAuth('trial')}
                  className="w-full sm:w-auto px-6 py-3.5 rounded-lg bg-white hover:bg-zinc-200 text-black font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-white/10 group"
                >
                  <span>Let AI Apply For Me (Free)</span>
            ...
            {existingUser ? (
              ...
              <div className={`p-6 sm:p-7 w-full border bg-[#09090b] rounded-2xl shadow-xl space-y-5 relative overflow-hidden transition-all duration-500 ${
                ...
                <div className="flex items-center bg-black p-1 rounded-lg border border-zinc-800">
                  <button
                    type="button"
                    onClick={() => { setAuthMode('signin'); setError(''); setForgotSent(false) }}
                ...
                {authMode === 'forgot' ? (
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] text-sky-400 font-mono px-2 py-0.5 rounded bg-sky-950/40 border border-sky-800/60">
                          Account Recovery
                        </span>
                      </div>
                      <p className="text-xs text-zinc-400 mt-1">
                        Enter your account email to receive a secure reset link and 6-digit verification code.
                      </p>
                    </div>
                    ...
                    {forgotSent ? (
                      <div className="space-y-4 py-2">
                        ...
                        <a
                          ...
                          className="w-full py-2.5 bg-white hover:bg-zinc-200 text-black font-semibold rounded-lg text-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                        >
                  ...
                  /* Standard Sign In / Trial Flow */
                  <>
                    <div>
                      <div className="flex items-center justify-between">
                        <h2 className="text-lg font-bold text-white">
                          {authMode === 'trial' ? 'Let AI Apply For You' : 'Welcome Back'}
                        </h2>
                        <span className={`text-[10px] font-mono px-2 py-0.5 rounded border ${
                          ...
                          {authMode === 'trial' ? '100% Free' : 'Member Login'}
                        </span>
                      </div>
                      <p className="text-xs text-zinc-400 mt-1">
                        {authMode === 'trial'
                          ? 'Create your free account in 30 seconds. Zero payment required.'
                          : 'Sign in to monitor your active application queue and interview calls.'}
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleAuth} className="space-y-3.5">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          {authMode === 'signin' && (
                            <button
                              type="button"
                              onClick={() => { setAuthMode('forgot'); setError(''); setForgotSent(false) }}
                      ...
                      >
                        {loading ? (
                          ...
                          <>
                            <span>{authMode === 'trial' ? 'Start Free — Let AI Apply →' : 'Sign In to Dashboard →'}</span>
                          </>
                        )}
                      </button>
