...
export default function AdminOverviewStats({
  ...
  void notificationBannerDismissed
  return (
    <div className="px-4 py-2 rounded-2xl bg-[#09090b] light:bg-white border border-zinc-800/90 light:border-zinc-200 shadow-sm flex items-center gap-x-4 gap-y-1 flex-wrap text-xs">
      <span className="flex items-center gap-2 min-w-0" title="Worker cluster telemetry · daily sweep 06:00 AM IST">
        <span className="relative flex h-2 w-2 shrink-0">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
          <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
        </span>
        <strong className="text-zinc-200 light:text-zinc-900 font-semibold tracking-wide whitespace-nowrap">Cluster Active</strong>
        <span className="text-zinc-500 light:text-zinc-600 font-mono text-[11px] hidden md:inline whitespace-nowrap">06:00 IST</span>
      </span>
      ...
      <span className="flex items-center gap-2 shrink-0 ml-auto text-[11px]">
