                        ...
                        <td className="py-3.5 px-4 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-1.5">
                            <a
                              ...
                              className="p-1.5 rounded-lg bg-black hover:bg-zinc-800 border border-zinc-800 text-zinc-400 hover:text-white transition-colors inline-flex items-center cursor-pointer"
