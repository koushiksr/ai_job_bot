...
export default function JobFluxFourPillars({
  ...
  return (
    <section id="why-jobflux" className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 border-t border-zinc-900 z-10 space-y-12 scroll-mt-20">
      {/* Section Header */}
      <div className="text-center max-w-3xl mx-auto space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-950 border border-zinc-800 text-zinc-300 text-xs font-mono">
          <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />
          <span className="font-semibold text-white">THE CAREER REVOLUTION</span>
          <span className="text-zinc-600">·</span>
          <span className="text-zinc-400">NEED • STATUS • PASSION • TRUST</span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#09090b] border border-zinc-800/80 hover:border-amber-500/30 transition-all space-y-4 relative overflow-hidden group">
          ...
          <div className="w-12 h-12 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.15)]">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#09090b] border border-zinc-800/80 hover:border-sky-500/30 transition-all space-y-4 relative overflow-hidden group">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#09090b] border border-zinc-800/80 hover:border-rose-500/30 transition-all space-y-4 relative overflow-hidden group">
          ...
          <div className="w-12 h-12 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 shadow-[0_0_15px_rgba(244,63,94,0.15)]">
          ...
          <div className="pt-2 border-t border-zinc-800/60 flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 text-rose-300 font-mono text-[11px] font-semibold">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#09090b] border border-zinc-800/80 hover:border-emerald-500/30 transition-all space-y-4 relative overflow-hidden group">
          ...
          <div className="pt-2 border-t border-zinc-800/60 flex items-center justify-between text-xs">
            <div className="flex items-center gap-1.5 text-emerald-300 font-mono text-[11px] font-semibold">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 border border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-6 shadow-2xl">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="px-6 py-3 rounded-xl bg-white hover:bg-zinc-200 text-black font-extrabold text-xs sm:text-sm transition-all flex items-center gap-2 shadow-xl shadow-white/10 cursor-pointer"
          >
