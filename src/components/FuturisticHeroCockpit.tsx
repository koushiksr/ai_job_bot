    ...
    <div className="w-full relative">
      ...
      <div className="relative rounded-3xl glass-card-futuristic p-5 sm:p-7 overflow-hidden shadow-2xl border border-cyan-500/20">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-zinc-800/80">
          ...
          {/* Segmented Mode Switcher — equal-weight tabs */}
          <div className="flex items-center bg-zinc-950/80 p-1 rounded-xl border border-zinc-800 self-start sm:self-auto gap-1">
            <button
              type="button"
        ...
        {authMode === 'signin' && (
          <form onSubmit={handleSubmit} className="pt-4 space-y-3.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  className="w-full bg-black border border-zinc-800 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/20 rounded-xl pl-10 pr-3 py-2.5 text-xs text-white placeholder-zinc-600 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black border border-zinc-800 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/20 rounded-xl pl-10 pr-10 py-2.5 text-xs text-white placeholder-zinc-600 outline-none transition-all"
                />
                <button
                  type="button"
            ...
            {error && (
              <div className="p-3 bg-red-950/40 border border-red-800/50 text-red-300 rounded-xl text-xs flex items-start gap-2">
            ...
            >
              {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <><span>Sign In to Dashboard</span><ArrowRight className="w-3.5 h-3.5" /></>}
            </button>

            {/* Divider */}
            <div className="flex items-center gap-2 text-zinc-700 text-[10px] font-mono">
            ...
            <button
              ...
              onClick={handleGoogleAuth}
              disabled={loading}
              className="w-full py-2.5 rounded-xl text-xs font-semibold bg-zinc-950 hover:bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-zinc-200 flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
              <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
                <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
            ...
            <div className="pt-1 border-t border-zinc-900">
              <div className="flex items-center gap-2 p-2.5 rounded-lg bg-indigo-950/30 border border-indigo-800/40 text-[10px] text-indigo-300">
                <Building2 className="w-3 h-3 shrink-0 text-indigo-400" />
                <span>
                  Enterprise Admin?{' '}
                  <span className="text-zinc-300">Sign in above with your registered email and password, or use Google if you signed up via Google.</span>
                </span>
              </div>
            </div>
          </form>
