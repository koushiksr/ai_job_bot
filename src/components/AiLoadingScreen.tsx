...
export default function AiLoadingScreen({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] rounded-full bg-sky-500/15 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-4 text-center px-4 my-auto">
        ...
        <div className="relative flex items-center justify-center">
          <div className="w-16 h-16 rounded-2xl border border-sky-500/40 animate-radar-pulse absolute inset-0 -m-1 pointer-events-none" />
