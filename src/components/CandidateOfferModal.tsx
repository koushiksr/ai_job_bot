      ...
      >
        ...
        <div className="p-6 sm:p-8 relative z-10">
          ...
          <div className="flex items-center gap-2 mb-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-amber-400/20 text-amber-300 border border-amber-400/40 shadow-[0_0_12px_rgba(245,158,11,0.3)]">
              <Flame className="w-3.5 h-3.5 text-amber-400 animate-pulse" />
              <span>{activeOffer.discount_badge || 'Exclusive Candidate Offer'}</span>
            </span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-medium bg-red-500/15 text-red-400 border border-red-500/30">
          ...
          {/* Price Showcase Card */}
          <div className="mt-6 p-4 rounded-2xl bg-zinc-900/90 border border-zinc-800/80 flex items-center justify-between">
            <div>
              <span className="text-xs text-zinc-400 block font-medium">Exclusive Unlocked Price</span>
            ...
            <div className="flex flex-col items-end">
              <span className="text-[11px] text-zinc-400 mb-1 flex items-center gap-1">
              ...
              <button
                ...
                type="button"
                className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-black/60 hover:bg-zinc-800 border border-dashed border-amber-400/60 text-amber-300 text-xs font-mono font-bold transition-all cursor-pointer group"
              ...
              >
                ...
                {copied ? (
                  ...
                  <Copy className="w-3.5 h-3.5 text-zinc-400 group-hover:text-amber-300 transition-colors" />
                )}
              </button>
              {copied && (
                <span className="text-[10px] text-emerald-400 font-semibold mt-1">Copied to clipboard!</span>
              )}
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-3.5 rounded-2xl bg-zinc-900/90 hover:bg-zinc-800 text-zinc-300 hover:text-white text-sm font-semibold border border-zinc-800 transition-colors cursor-pointer text-center"
            >
              Maybe Later
            </button>
          </div>
